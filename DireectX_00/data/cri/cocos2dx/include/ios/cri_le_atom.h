...
/* バージョン情報 */
/* Version Number */
#define CRI_ATOM_VERSION				(0x02100000)
#define CRI_ATOM_VER_NUM				"2.10.00"
...
/*JP
 * \brief トゥルーピークメータ機能コンフィグ構造体にデフォルト値をセット
 * \ingroup ATOMLIB_ASR
 * \par 説明:
