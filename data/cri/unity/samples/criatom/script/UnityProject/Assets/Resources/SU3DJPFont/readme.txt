...
Selected U3D Japanese Fonts   04/19/2011

------------------------------------------------------------------------
# English

  Selected U3D Japanese Fonts is based on M+OUTLINE Font TESTFLIGHT036 M+C.
  ...
  * 111 Kanji in Japan states name and game words
...
# Japanese ( 日本語 )
  ...
  Selected U3D Japanese Fontsは M+OUTLINEフォントTESTFLIGHT036 M+Cを基盤にしています。
  主にモバイル機器に最適な文字サイズとテクスチャサイズを両立するために、  フォントに含む文字を
  以下に限定して再構成したTTFファイルです。
  これらの文字セットによって、1024x1024のテクスチャであっても、25ポイントまでの大きさを持てる特徴があります。
