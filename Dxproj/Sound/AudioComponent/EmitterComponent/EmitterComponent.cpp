...
CEmitterComponent::CEmitterComponent()
{
	...
	m_Emitter.pLPFDirectCurve	= (X3DAUDIO_DISTANCE_CURVE*)Emitter_LPFE_Curve; // use default curve
	...
	m_Emitter.DopplerScaler		= FLT_MAX;
...
void CEmitterComponent::MoveVelocity(D3DXVECTOR3* move)
{
	m_Velocity = move;
}
