...
CCamera::CCamera()
{
	...
	m_LocalPosition = D3DXVECTOR3(0, 0, -m_Distance);
...
void CCamera::LateDraw()
{
	...
	D3DXMatrixPerspectiveFovLH(&m_ProjectionMatrix, FOVY, (FLOAT)CWindowCreate::Getintance().GetASPECT(), (FLOAT)NEAR_CLIP, (FLOAT)FAR_CLIP);
